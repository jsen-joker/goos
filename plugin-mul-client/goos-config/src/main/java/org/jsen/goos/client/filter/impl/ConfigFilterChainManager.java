 ...
 */
package org.jsen.goos.client.filter.impl;

import com.google.common.collect.Lists;
import org.jsen.goos.client.exception.GoosClientException;
import org.jsen.goos.client.filter.IConfigFilter;
import org.jsen.goos.client.filter.IConfigFilterChain;
import org.jsen.goos.client.filter.IConfigRequest;
import org.jsen.goos.client.filter.IConfigResponse;
...
public class ConfigFilterChainManager implements IConfigFilterChain {
    ...
    @Override
    public void doFilter(IConfigRequest request, IConfigResponse response) throws GoosClientException {
    ...
    private static class VirtualFilterChain implements IConfigFilterChain {
        ...
        @Override
        public void doFilter(final IConfigRequest request, final IConfigResponse response) throws GoosClientException {
