 ...
 */
package org.jsen.goos.client.exception;
 ...
 * @author Nacos
 */
public class GoosClientException extends Exception {
    ...
    public GoosClientException() {
    }

    public GoosClientException(int errCode, String errMsg) {
