...
import org.jsen.goos.client.ConfigFactory;
...
import static org.jsen.goos.client.utils.http.Constants.ENCODE;
import static org.jsen.goos.client.utils.http.impl.PropertyKeyConst.*;

/**
 * goos config properties
 */
@ConfigurationProperties("spring.cloud.goos.config")
public class GoosConfigProperties {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GoosConfigProperties.class);
